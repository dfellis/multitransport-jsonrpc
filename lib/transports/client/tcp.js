    ...
    if(this.config.retries && this.config.retry < this.config.retries) {
        ...
        function reconnect() {
            ...
            this.con = net.connect({
                ...
                if(this.config.reconnectInterval) clearInterval(this.config.reconnectInterval);
        ...
        if(this.config.retry === 1) reconnect.call(this);
        this.config.reconnectInterval = setInterval(reconnect.bind(this), this.config.retryInterval);
    } else {
